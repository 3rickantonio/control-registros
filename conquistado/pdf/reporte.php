...
$queEmp = "SELECT nombres, apellidos, telf_movil, direccion,estatus FROM conquistado ORDER BY id ASC";
$resEmp = mysql_query($queEmp, $conexion) or die(mysql_error());
$totEmp = mysql_num_rows($resEmp);
/*
$conexion = mysql_connect("localhost", "cristoes", "");
mysql_select_db("conquistando", $conexion);
$queEmp = "SELECT nombres, apellidos, telf_movil, direccion,estatus FROM conquistado ORDER BY estatus DESC";
$resEmp = mysql_query($queEmp, $conexion) or die(mysql_error());
$totEmp = mysql_num_rows($resEmp);
*/
